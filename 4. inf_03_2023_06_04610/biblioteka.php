...
<div id="prawy2">
        <!-- skrypt 2 
        1. Pobiera dane z formularza --- if($POST){}
        2. Wysyła do bazy danych zmodyfikowane zapytanie 2 tak, że wstawia do bazy danych dane
        z formularza
        3. Wyświetla napis „Czytelnik <imie> <nazwisko> został(a) dodany do bazy danych” (gdzie pola <>
    ...
    if($wynik2){
        echo "Czytelnik $imie $nazwisko został dodany do bazy";
    }
}
