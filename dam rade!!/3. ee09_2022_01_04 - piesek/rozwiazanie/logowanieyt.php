...
<head>
    ...
    <link rel="stylesheet" href="styl4_yt.css">
</head>
<body>
    <div id="baner">
    ...
    <div id="prawy1">
        <h2>Zapisz się</h2>
        <form action="logowanieyt.php" method="post">
            login: 
        ...
        <?php
            //skrypt
            $polaczenie = mysqli_connect('localhost', 'root', '', '2022_psy');
            if(empty($_POST['login']) || empty($_POST['haslo']) || empty($_POST['phaslo'])){
                ...
                if ($ile > 0){
                    ...
                    $zapytanie2 = "INSERT INTO uzytkownicy3  VALUES (NULL, '$login', '$haslo_szyfr');";
